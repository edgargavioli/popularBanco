...
def Adress():
    for _ in range(num_registros):
        ...
        State_id_state = random.randrange(1,27)
        mycursor.execute("INSERT INTO address(street, zip_code, number, City_id_city, State_id_state) VALUES(%s, %s, %s, %s, %s)",(street, zip_code, num, City_id_city, State_id_state))
...
#   mycursor.execute("INSERT INTO result(name) VALUES(%s)", (status,))
